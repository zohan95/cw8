...
class Product(models.Model):
    ...
    category = models.CharField(max_length=63, choices=PRODUCT_CATEGORY, default=PRODUCT_CATEGORY[2][0], verbose_name='Категории')
...
class Review(models.Model):
    ...
    product = models.ForeignKey('Product', related_name='review_product', verbose_name='Товар', on_delete=models.CASCADE)
